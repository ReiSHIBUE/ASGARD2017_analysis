...
###
### OUTPUT:
###   output_p/18Sclass_boxplots_processing.pdf
###   output_p/18Sphylum_boxplots_processing.pdf
###   output_p/ASGARD_hm_processing_18S.pdf
...
pdf(file = here::here("output_p", "boxplots", "18Sclass_boxplots_processing.pdf"))
...
pdf(file = here::here("output_p", "boxplots", "18Sphylum_boxplots_processing.pdf"))
...
pdf(file = here::here("output_p", "heatmaps", "ASGARD_hm_processing_18S.pdf"), width = 20, height = 20)
